...
const LeBlanc = () => {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-background">
      ...
      {!isMobile && <AppHeader openDialog={openDialog} openComingSoonDialog={openComingSoonDialog} />}
      
      <main className={isMobile ? "pt-0" : "pt-16"}>
        {/* Hero Section */}
        <section className={`relative ${isMobile ? "h-screen" : "pt-12 md:pt-16 pb-16 md:pb-20 px-4 min-h-[80vh]"} flex items-center`}>
          ...
          <div className={`container mx-auto relative z-20 ${isMobile ? "h-full flex flex-col justify-center px-6" : "flex flex-col lg:flex-row items-center justify-between gap-8"}`}>
            {isMobile ? (
              <div className="text-center">
                ...
                >
                  <div className="mb-6">
                    <p className="text-sm text-gray-300 uppercase tracking-wider mb-1 font-medium">CRAIG LEBLANC</p>
                  ...
                  <div className="mt-auto">
                    <Button 
                      onClick={openDialog} 
                      className="w-full bg-black border border-white/20 text-white py-3 rounded-md text-lg font-bold hover:bg-white/10 transition-colors inline-flex items-center justify-center"
                    >
                      JOIN WAITLIST
                    ...
                    <div className="mt-4 text-xs text-gray-400">
                      <p>200+ ATHLETES ALREADY ON THE WAITLIST</p>
                    </div>
                  </div>
                </motion.div>
              </div>
                ...
                <div className="lg:w-1/2">
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Button 
                        onClick={openDialog} 
                        className="metal-gradient text-white px-8 py-4 rounded-md text-lg font-bold hover:opacity-90 transition-opacity inline-flex items-center justify-center group"
                      >
                        Join Waitlist
        ...
        {/* Only show these sections on desktop view or when scrolled down on mobile */}
        {!isMobile && (
          <>
            {/* Logos Section */}
      ...
      {!isMobile && <AppFooter openComingSoonDialog={openComingSoonDialog} />}
    </div>
  );
};
