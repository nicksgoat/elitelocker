...
const FunnelStep: React.FC<FunnelStepProps> = ({ 
  ...
  return (
    <motion.div
      ...
      animate={controls}
      variants={variants}
      className="flex flex-col items-center text-center max-w-md mx-auto relative z-10 bg-black/20 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/5"
    >
      ...
      <ul className="mb-2">
        {description.map((item, itemIndex) => (
          <motion.li 
            ...
            transition={{ delay: delay + (itemIndex * 0.1), duration: 0.4 }}
...
export const FunnelDiagram: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-black to-secondary/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <motion.h2 
          ...
          className="text-3xl md:text-5xl font-bold text-center mb-16 text-primary bg-clip-text"
        >
