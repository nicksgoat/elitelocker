      ...
      <div className="container mx-auto py-[11px]">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="flex justify-center w-full bg-transparent py-4">
            <TabsTrigger value="featured" className="flex items-center gap-2 px-6 py-2 data-[state=active]:text-primary transition-all duration-200 bg-[#111111]">
              <Activity className="w-4 h-4" />
              <span className="font-medium">Featured</span>
            </TabsTrigger>
            <TabsTrigger value="exercises" className="flex items-center gap-2 px-6 py-2 data-[state=active]:bg-primary/20 data-[state=active]:text-primary transition-all duration-200">
